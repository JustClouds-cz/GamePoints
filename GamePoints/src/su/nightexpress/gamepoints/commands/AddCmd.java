...
public class AddCmd extends ISubCommand<GamePoints> {

	public AddCmd(@NotNull GamePoints plugin) {
		super(plugin, new String[] {"add"}, Perms.ADMIN);
	}
	...
	public void perform(@NotNull CommandSender sender, @NotNull String label, @NotNull String[] args) {
		...
		if (player != null) {
			plugin.lang().Command_Add_Done_User
